...
var Dispatcher = function () {
  ...
  _createClass(Dispatcher, [{
    ...
    value: function publish(event, data) {
      ...
      this.events[event].forEach(function (callack) {
        callack(data || {});
      });
    }
  }]);
...
var Store = function () {
  ...
  _createClass(Store, [{
    ...
    value: function getPosts() {
      ...
      return _axios2.default.get(ghost.url.api('posts', {
        page: page,
        limit: limit,
        include: 'author,tags'
      }));
    ...
    value: function getPost(slug) {
      return _axios2.default.get(ghost.url.api('posts', 'slug', slug, {
        include: 'author,tags'
      }));
    }
  }, {
    key: 'getJournalPosts',
    value: function getJournalPosts() {
      var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
...
var _LazyLoader = __webpack_require__(163);
...
var _Journal = __webpack_require__(162);
...
var App = function () {
  function App() {
    ...
    var $loopPosts = document.querySelector('[data-loop-posts]');
    var $post = document.querySelector('[data-post]');
    var $journal = document.querySelector('[data-journal]');
    var pageLimit = 4;
    this.lazyLoader = new _LazyLoader2.default('[data-lazy-load]');

    if ($loopPosts) {
      this.pagination = new _Pagination2.default($loopPosts, pageLimit);
    }

    if ($loadMore) {
      $loadMore.addEventListener('click', function (event) {
        _this.handleLoadMore(event, $loadMore);
      });
    }

    if ($post) {
      this.post = new _Post2.default($post);
    }

    if ($journal) {
      this.journal = new _Journal2.default($journal);
    }
  }

  _createClass(App, [{
    key: 'handleLoadMore',
    value: function handleLoadMore(event, $element) {
      var _this2 = this;
      ...
      this.pagination.next(function () {
        var state = _this2.pagination.state;
...
var _runtime = __webpack_require__(29);

var _runtime2 = _interopRequireDefault(_runtime);

var _downsize = __webpack_require__(167);

var _downsize2 = _interopRequireDefault(_downsize);

var _pick = __webpack_require__(245);
...
_runtime2.default.registerHelper('excerpt', function (options) {
  var truncateOptions = options.hash || {};
  var html = options.data.root.html;
  var excerpt = html.replace(/<a href="#fn.*?rel="footnote">.*?<\/a>/gi, '');
  excerpt = excerpt.replace(/<div class="footnotes"><ol>.*?<\/ol><\/div>/, '');
  excerpt = excerpt.replace(/<\/?[^>]+>/gi, '');
  excerpt = excerpt.replace(/(\r\n|\n|\r)+/gm, ' ');
  truncateOptions = (0, _pick2.default)(truncateOptions, ['words', 'characters']);

  return new _runtime2.default.SafeString((0, _downsize2.default)(excerpt, truncateOptions));
});

_runtime2.default.registerHelper('date', function (options) {
  var format = options.hash.format || 'MMM DD, YYYY';
  var date = (0, _moment2.default)(options.data.root.date).format(format);

  return new _runtime2.default.SafeString(date);
});

_runtime2.default.registerHelper('lazy', function (options) {
  console.log(options);
...
var _journalPost = __webpack_require__(254);

var _journalPost2 = _interopRequireDefault(_journalPost);

var _journalSingle = __webpack_require__(255);

var _journalSingle2 = _interopRequireDefault(_journalSingle);
...
var Journal = function () {
  function Journal($element) {
    ...
    _store2.default.getJournalPosts().then(function (res) {
      _this.posts = res.data.posts;

      _this.posts.forEach(_this.render.bind(_this));
      _dispatcher2.default.publish(_actions2.default.POSTS_CHANGED, null);
    });
  }

  _createClass(Journal, [{
    key: 'createPostModal',
    value: function createPostModal() {
    ...
    value: function render(post) {
      ...
      this.$element.innerHTML += (0, _journalPost2.default)({
        image: post.image,
        url: post.url,
        title: post.title,
      ...
      [].concat(_toConsumableArray($posts)).forEach(this.renderPost.bind(this));
    }
  }, {
    key: 'renderPost',
    value: function renderPost($post) {
      ...
      $post.addEventListener('click', function (event) {
        ...
        var post = _this2.getPostBySlug();
        _this2.handlePostClick(post);
      });
    }
  }, {
    key: 'handlePostClick',
    ...
    value: function openPostModal(post) {
      ...
      this.$modal.innerHTML = (0, _journalSingle2.default)({
        title: post.title
      });
    }
  }, {
...
var _inViewport = __webpack_require__(184);
...
var _verge = __webpack_require__(250);
...
var LazyLoader = function () {
  function LazyLoader(selector) {
    ...
    window.addEventListener('scroll', function () {
      (0, _throttle2.default)(_this.query.bind(_this), 2500)();
    });

    _dispatcher2.default.subscribe(_actions2.default.POSTS_CHANGED, this.render.bind(this));
    this.render();
  }
  ...
  _createClass(LazyLoader, [{
    ...
    value: function add($element) {
      ...
      if ($element instanceof HTMLImageElement) {} else {
    ...
    value: function query() {
      this.instances.forEach(function (instance) {
        if (!instance.isLoaded && _verge2.default.inViewport(instance.$element, 50)) {
          instance.load();
        }
      });
    }
...
var LazyElement = function LazyElement($element) {
...
var LazyBackground = function (_LazyElement) {
  _inherits(LazyBackground, _LazyElement);

  function LazyBackground($element) {
    _classCallCheck(this, LazyBackground);

    var _this3 = _possibleConstructorReturn(this, (LazyBackground.__proto__ || Object.getPrototypeOf(LazyBackground)).call(this, $element));

    _this3.$element.setAttribute('lazy-element', '');
    return _this3;
  }
...
var _loopPost = __webpack_require__(168);

var _loopPost2 = _interopRequireDefault(_loopPost);
...
var Pagination = function () {
  function Pagination($element, limit) {
  ...
  _createClass(Pagination, [{
    ...
    value: function next(callback) {
      ...
      _store2.default.getPosts(this.currentPage, this.limit).then(function (res) {
        var posts = res.data.posts;
        var meta = res.data.meta;

        _this.state = meta.pagination;

        posts.forEach(_this.render.bind(_this));
        _dispatcher2.default.publish(_actions2.default.POSTS_CHANGED, null);
    ...
    key: 'render',
    value: function render(post) {
      this.$element.innerHTML += (0, _loopPost2.default)({
        image: post.image,
        url: post.url,
        title: post.title,
        date: post.published_at,
...
var isElementInView = function isElementInView($element) {
  var fullyInView = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

  var pageTop = window.pageYOffset ? window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop;
  var pageBottom = window.innerHeight || document.documentElement.clientHeight;
...
var XRegexp = __webpack_require__(252).XRegExp;
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
    return "      <section class=\"loop__post--excerpt\">\n        <p>\n          "
    + container.escapeExpression((helpers.excerpt || (depth0 && depth0.excerpt) || helpers.helperMissing).call(depth0 != null ? depth0 : {},{"name":"excerpt","hash":{"words":"42"},"data":data}))
    + "\n        </p>\n      </section>\n";
  ...
  return "<article class=\""
    ...
    + " loop__post\">\n  <div class=\"loop__post--cover\" data-lazy-load=\""
    + alias4(((helper = (helper = helpers.image || (depth0 != null ? depth0.image : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"image","hash":{},"data":data}) : helper)))
    + "\">\n\n  </div>\n  <div class=\"loop__post--body\">\n    <header class=\"loop__post--header\">\n      <h2 class=\"loop__post--title\">\n        <a href=\""
    + alias4(((helper = (helper = helpers.url || (depth0 != null ? depth0.url : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"url","hash":{},"data":data}) : helper)))
    + "\">"
    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
    + "</a>\n      </h2>\n    </header>\n\n"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = (depth0 != null ? depth0.html : depth0)) != null ? stack1.length : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "\n    <footer class=\"loop__post--meta\">\n      <time class=\"loop__post--date\" datetime=\""
    + alias4((helpers.date || (depth0 && depth0.date) || alias2).call(alias1,{"name":"date","hash":{"format":"MM-DD-YYYY"},"data":data}))
    + "\">\n        "
    + alias4((helpers.date || (depth0 && depth0.date) || alias2).call(alias1,{"name":"date","hash":{"format":"MMMM DD, YYYY"},"data":data}))
    + "\n      </time>\n\n      <div class=\"loop__post--author\">\n        by "
    + alias4(container.lambda(((stack1 = (depth0 != null ? depth0.author : depth0)) != null ? stack1.name : stack1), depth0))
    + "\n      </div>\n\n      <div class=\"loop__post--tags\">\n        <label>Tags:</label>\n"
...
var _handlebarsSafeString = __webpack_require__(183);
...
var _handlebarsRuntime = __webpack_require__(182);

var runtime = _interopRequireWildcard(_handlebarsRuntime);

var _handlebarsNoConflict = __webpack_require__(181);
...
var _decoratorsInline = __webpack_require__(171);
...
var _helpersBlockHelperMissing = __webpack_require__(173);

var _helpersBlockHelperMissing2 = _interopRequireDefault(_helpersBlockHelperMissing);

var _helpersEach = __webpack_require__(174);

var _helpersEach2 = _interopRequireDefault(_helpersEach);

var _helpersHelperMissing = __webpack_require__(175);

var _helpersHelperMissing2 = _interopRequireDefault(_helpersHelperMissing);

var _helpersIf = __webpack_require__(176);

var _helpersIf2 = _interopRequireDefault(_helpersIf);

var _helpersLog = __webpack_require__(177);

var _helpersLog2 = _interopRequireDefault(_helpersLog);

var _helpersLookup = __webpack_require__(178);

var _helpersLookup2 = _interopRequireDefault(_helpersLookup);

var _helpersWith = __webpack_require__(179);
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<a href=\""
    ...
    + "\" class=\""
    + alias4(((helper = (helper = helpers.post_class || (depth0 != null ? depth0.post_class : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"post_class","hash":{},"data":data}) : helper)))
    + " journal__post\" data-journal-post>\n  <div class=\"journal__post--inner\">\n    <div class=\"journal__post--cover\" data-lazy-load=\""
    + alias4(((helper = (helper = helpers.image || (depth0 != null ? depth0.image : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"image","hash":{},"data":data}) : helper)))
    + "\"></div>\n  </div>\n</a>";
},"useData":true});
